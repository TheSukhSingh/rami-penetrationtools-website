...
// Dummy current-user fetcher (replace with real API later)
async function getCurrentUserStub() {
  // return null to simulate logged-out state if you want
  return { username: "sukh", name: "Sukh", email: "sukh@domain.com" };
}
